        ...
        for x in range(img2.size[0]):
            for y in range(img2.size[1]-1):
                ...
                if sens_val==None:
                    ...
                    if(sens_val == 1000+addr):{sens_val = sens_val2}
                    if(sens_val2 == 1000+addr):{sens_val2 = sens_val}
                    sens_val = int((sens_val+sens_val2)/2)
                    if(sens_val == 1000+addr):{data2[x,y+1] = not_connected_color}
                    else:
        ...
        for x in range(img3.size[0]):
            for y in range(img3.size[1]-1):
                ...
                if sens_val==None:
                    ...
                    if(sens_val2 == 1000+addr):{sens_val2 = sens_val}
                    sens_val = int((sens_val + sens_val2)/2)
                    if(sens_val == 1000+addr):{data3[x,y+1] = not_connected_color}
                    else:
                        sens_val = int((sens_val/65535)*255)
